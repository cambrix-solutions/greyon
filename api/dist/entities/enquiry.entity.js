...
], Enquiry.prototype, "consent", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: enums_1.EnquiryStatus, default: enums_1.EnquiryStatus.NEW }),
    __metadata("design:type", String)
], Enquiry.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'internal_notes', type: 'text', nullable: true }),
    __metadata("design:type", String)
], Enquiry.prototype, "internalNotes", void 0);
__decorate([
